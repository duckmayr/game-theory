...
The required text for the course is *An Introduction to Game Theory* by Martin J. Osborne.
...
We then meet on Wednesday to go over skills and material relevant to that problem set, and I have office hours on Thursday if you have additional questions.
...
The midterm exam will cover games of incomplete information.
...
2. Games of incomplete information
   ...
   C.  Sequential games with incomplete information and Perfect Bayesian Equilibrium
       - Weeks Twelve through Fourteen: Sequential games with incomplete information, Osborne Chapter 10
