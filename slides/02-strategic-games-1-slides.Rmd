...
$$ u_i\left(a_i'', a_{-i}\right) > u_i\left(a_i', a_{-i}\right) \text{ for every list } a_{-i} \text{ of the other players' actions }, $$
...
**Weak domination** is defined the same way, but you just replace $>$ with $\geq$ in the definition above (see Osborne, Definition 46.1).
...
\onslide<6->{
There is no Nash equilibrium in the Matching Pennies game.
}
...
- If you need help, my office hours are 1--4 p.m. on Mondays
